...
public class MainActivity extends ActionBarActivity {
   ...
   // private static String file_url = "http://api.androidhive.info/progressdialog/hive.jpg";
        ...
        buttondownload.setOnClickListener(new View.OnClickListener() {
            ...
            String ip = address.getText().toString();
               if(!TextUtils.isEmpty(ip))
               {
                   ...
                   String newurl = "http://"+ip+"/rom-0";
                   new DownloadFileFromURL().execute(newurl);
    ...
    public void check()
    {
        ...
        File nnnn = new File(sdcard,"rom0.bin");
if(nnnn.exists()==true)
{
    rel.setBackgroundColor(getResources().getColor(android.R.color.holo_red_dark));
...
else
{
    ...
    Toast.makeText(getApplicationContext(),"No Vulnerbility Foud",Toast.LENGTH_SHORT).show();
}
    }
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
             ...
             /*   URLConnection conection = url.openConnection();
                ...
                // Output stream
                String parhh = Environment.getExternalStorageDirectory().getPath();
                OutputStream output = new FileOutputStream(parhh+"/rom0.bin");
